...
//using TaskCentralWebApp.Models.TaskCentralDBContext;

namespace TaskCentralWebApp.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (!isUnique)
                {
                    ModelState.AddModelError("Input.Name", "User Name must be unique.");
                }
                else
                {
                    ...
                    if (result.Succeeded)
                    {
                        ...
                        else
                        {
                            ...
                            // Add a new record to your User table
                            var newUser = new User
                            {
                                UserName = Input.Name,
                                // Set the value of the IdentityUserId property to the value of the Id property of the IdentityUser class
                                AspUserId = user.Id
                            };
